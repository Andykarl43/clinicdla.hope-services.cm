    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">NOM DE POSTULANT: <?= $nom . ' ' . $prenom . ' (' . $matricule . ')' ?> </h1>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane container active" id="home">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <form class="form-horizontal" action="update_post_pers.php"
                                                          method="POST">
                                                        <div class="card-header">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                background: transparent;" required>
                                                                                        ...
                                                                                        <option value="1">FORMATION
                                                                                        </option>
                                                                                        <option value="2">EMPLOYÉ
                                                                                        </option>
                                                                                        <option value="3">LITIGE
                                                                                        </option>
