    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Liste des Utilisateurs/ Patients</h1>
                            ...
                            <div class="card-header">
                                ...
                                <b>
                                    ...
                                    <ul class="nav nav-pills" style="float: right;  margin-right: 20px ;">
                                        <li class="nav-item">
                                            <a class="btn btn-primary" href="nouveau_user_patient.php">
                                                <i class="fas fa-plus"></i>
                                                Nouveeau User patient
                                            </a>
                                        </li>
                                    </ul>
                                </b>
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="">
                                                    <table class="table table-bordered table-hover" id="dataTable"
                                                        ...
                                                        $query = "SELECT * from users_patients";
                                                        $q = $db->query($query);
                                                        while ($row = $q->fetch()) {
                                                            $id_user = $row['id_users'];
                                                            $id_perso = $row['id_patient'];
                                                            $pseudo = $row['pseudo'];
                                                            $lvl_user = $row['lvl'];
                                                            $date = $row['date'];
