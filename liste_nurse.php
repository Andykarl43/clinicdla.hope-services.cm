                                    ...
                                    <tr>
                                        <td><img width="28" height="28" src="assetss/img/user.jpg"
                                                 class="rounded-circle m-r-5" alt=""><a
                                                    href="details_nurse.php?id=<?= $id_nurse ?>"><?php echo $nom_n . ' ' . $prenom_n ?></a>
                                        </td>
                                        <td><a href="details_nurse.php?id=<?= $id_nurse ?>"><?=$departement?></a></td>
                                        </td>
                                        <td><a href="details_nurse.php?id=<?= $id_nurse ?>"><?= $type_n ?></a></td>
                                        <td><a href="details_nurse.php?id=<?= $id_nurse ?>"><?= $phone_n ?></a></td>
                                        <td><a href="details_nurse.php?id=<?= $id_nurse ?>"><?= $email_n ?></a></td>
                                        <td class="text-right">
