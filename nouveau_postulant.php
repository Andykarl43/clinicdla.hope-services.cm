                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane container active" id="home">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <form class="form-horizontal" action="save_post_pers.php"
                                                          method="POST">
                                                        <div class="card-header">
                                    ...
                                    <div class="tab-pane container" id="menu2">
                                        ...
                                        <div class="row">
                                            <form class="form-horizontal" action="save_personnel_work.php" method="POST"
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered" width="100%"
                                                            ...
                                                            <tr>                                                                            <?php
                                                                ...
                                                                <td style="width: 20%">
                                                                    <input name="entreprise[]" style="width:100%"
                                                                           class="form-control">
                                                                </td>
                                                                <td style="width: 20%">
                                                                ...
                                                                <td style="width: 20%">
                                                                    <input name="fonction[]" style="width:100%"
                                                                           class="form-control">
                                                                </td>
                                                                <td style="width: 10%">
                                        ...
                                        <div class="row">
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                background: transparent;">
                                                                                                ...
                                                                                                <button type="button"
                                                                                                        data-toggle="modal"
                                                                                                        style="background-color: transparent">
                                                                                                    <a href="nouveau_parrain_externe.php"><i
                                                                                                                class="fas fa-plus"></i></a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                            ...
                                            <div class="card-footer">
                                                <div class="btn-toolbar" role="toolbar"
                                                     aria-label="Toolbar with button groups" style="float: right;">
                                                    <div class="btn-group mr-2" role="group" aria-label="First group">
                                                        <h5 class="bg-warning"><b><u>NB:</u></b> Veillez enregistrer
                                                            avant de passer à l'étape suivante ! </h5>
                                                    </div>
                                                    <div class="btn-group mr-2" role="group" aria-label="First group">
                                                        <button type="submit" name="submit_etat_civil"
                                                                class="btn btn-primary">Enregistrer
