                    ...
                    <div class="col-xl-12">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="liste_examen_suite.php">
                                ...
                                if($lvl == 9) {
                                    $query = "SELECT DISTINCT count(id_exa) as total from examen WHERE id_lab= '$id_perso_session' and etat=0 ";
                                }elseif($lvl == 5) {
                                    $query = "SELECT DISTINCT count(id_exa) as total from examen WHERE id_medecin = '$id_perso_session' and etat=0 ";
                                }else{
                                    $query = "SELECT DISTINCT count(id_exa) as total from examen where etat=0  ";
                                }
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                <?php
                                if ($lvl == 9) {
                                    $query = "SELECT * from examen where id_lab='$id_perso_session' and etat=1";
                                } elseif($lvl == 5){
                                    $query = "SELECT * from examen where id_medecin='$id_perso_session' and etat=1";
                                }else {

                                    $query = "SELECT * from examen where etat=1";
                                }
