                                    ...
                                    <ul class="nav nav-pills" style="float: right;">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="modal"
                                               data-target="#ajouterCat_materiel" href="#home">
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="">
                                                    <table class="table table-bordered table-hover" id="dataTable"
                                                        ...
                                                        <thead>
                                                        <tr class="bg-primary">
                                                            <th><p align="center" style="color: white">Catégories de
                                                                    matériaux</p></th>
                                                        ...
                                                        while ($row = $q->fetch()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center"><a class="btn btn-danger"
                                                                                      type="button"
                                                                                      data-toggle="modal"
                                                                                      data-target="#verifier_delete_cat_materiel<?= $id_cat_materiel; ?>"
                                                                                      title="supprimer"
                                                                                      style="background-color: transparent">
                                                                        <i style="color: red" class="fas fa-trash"></i>
                                                                    </a></td>
                                                                <?php
                                                                include("verifier_delete_cat_materiel.php");
                                                                ?>
