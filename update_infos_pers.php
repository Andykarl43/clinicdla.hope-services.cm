...
if ($_POST) {
    ...
    // $query1 = " INSERT INTO personnel (poste,date_embauche,type_contrat,statut,cout_h_sup,cout_horaire,matricule,number_cnps,nom_banque,number_card_bancaire,day_anciennete,month_anciennete,year_anciennete)
    // VALUES
    // (:poste,:date_embauche,:type_contrat,:statut,:cout_h_sup,:cout_horaire,:matricule,:number_cnps,:nom_banque,:number_card_bancaire,:day_anciennete,:month_anciennete,:year_anciennete)";

    $query1 = " UPDATE personnel SET  poste=:poste, date_embauche=:date_embauche, 
                    type_contrat=:type_contrat, statut=:statut, cout_h_sup=:cout_h_sup, cout_horaire=:cout_horaire, matricule=:matricule, number_cnps=:number_cnps, nom_banque=:nom_banque, number_card_bancaire=:number_card_bancaire, day_anciennete=:day_anciennete, month_anciennete=:month_anciennete, year_anciennete=:year_anciennete    WHERE id_personnel = '$id' ";
