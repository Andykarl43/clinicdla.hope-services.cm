    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Nouvelle entrepise</h1>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane container active" id="home">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <form class="form-horizontal" action="save_entreprise.php"
                                                          method="POST">
                                                        <div class="card-header">
                                                            ...
                                                            <fieldset>
                                                                <div class="table-responsive">
                                                                    <table border="0"
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 50%">
                                                                                <span class="help-block small-font">RFCCM:</span>
                                                                                <div class="col">
                                                                                    <input style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;"
                                                                                           name="ref_ent" required>
                                                                                </div>
                                                                            </td>
                                                                            <td style="width: 50%">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div class="col">
                                                                                    <select name="pays_ent" style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;">
                                                                    ...
                                                                    border-left-color: orange;">
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div class="col">
                                                                                    <select name="ville_ent" style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;">
                                                                                        <option value="" selected="">
                                                                                            ...
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                border-color: gray" name="email_ent">
                                                                                    </button>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
