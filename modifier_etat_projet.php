    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Statut de L'Appel d'offre : <?= $ref_offre ?></h1>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane container active" id="home">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <form class="form-horizontal" action="update_etat_projet.php"
                                                          method="POST">
                                                        <div class="card-header">
                                                                    ...
                                                                    <table class="table  table-hover table-condensed"
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                ?>
                                                                                <span class="help-block small-font">Statut du Projet</span>
                                                                            ...
                                                                            <td>
                                                                                <span class="help-block small-font">Commentaire:</span>
                                                                                <div class="col">
