        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <form action="save_ajouter_client.php" method="post">
                                                            ...
                                                            while ($row = $q->fetch()) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center" style="width: 18%">
                                                                        <!-- <a class="btn btn-primary"  href="details_client.php?id=<?php //echo $id;
                                                                        ?>" title="view"
                         ...
                         <a class="btn btn-warning" href="modifier_client.php?id=<? //=$id;
                                                                        ?>" title="Modifier"
                            style="background-color: transparent">
                             ...
                             <a class="btn btn-danger" type="button" data-toggle="modal" data-target="#verifier_delete_client<? //= $id;
