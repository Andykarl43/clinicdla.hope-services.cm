    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Nouvelle assurance</h1>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane container active" id="home">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <form class="form-horizontal" action="save_assurances.php"
                                                          method="POST">
                                                        <div class="card-header">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table border="0"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div class="col">
                                                                                    <select name="pays_ass" style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;">
                                                                    ...
                                                                    border-left-color: orange;">
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div class="col">
                                                                                    <select name="ville_ass" style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;">
                                                                                        <option value="" selected="">
                                                                                            ...
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                border-color: gray" name="email_ass">
                                                                                    </button>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
