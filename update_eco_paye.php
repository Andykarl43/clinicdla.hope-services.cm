    ...
    if($cnt_pers==1 )
    {
        if($cnt==0){
            if($somme-($payer+$remise)>=0){
                ...
                $query1 = "UPDATE regler_ecographie SET  payer=:payer, remise=:remise
                ...
                if($somme-($payer+$remise) == 0 ){
                    ...
                    $etat=1;
                    $query1 = "UPDATE regler_ecographie SET  etat=:etat
                    WHERE  id_eco='$id_eco' and id_reg_eco='$id_reg_eco'";
            ...
            if($somme-$payer_sum>=0){
                ...
                if ($sql1) {
                    ...
                    <script>
                        //alert('Consulattion a été bien mis à jour.');
                        window.location.href = 'liste_ecographie.php?witness=1';
                    </script>
                    <?php
                } else {
                    ?>
