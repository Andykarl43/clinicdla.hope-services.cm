        ...
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Modifier Règlement
                    client: <?php $sql = "SELECT DISTINCT * from client where id_client = '$id_client'";
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane container active" id="home">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <form class="form-horizontal" action="update_regle_client.php"
                                                          method="POST">
                                                        <div class="card-header">
                                                            <input type="hidden" name="id_regle_client"
                                                                   value="<?= $id_regle_client ?>">
                                                        </div>
                                                        <div class="card-body">
                                                            <fieldset>
                                                                            ...
                                                                            <td style=" width: 50%">
                                                                                ...
                                                                                background: transparent;"
                                                                                        ...
                                                                                        <option value="<?= $id_client ?>"
                                                                                                selected="">
                                                                                            <?php $sql = "SELECT DISTINCT * from client where id_client = '$id_client'";
                                        ...
                                        <center>
                                            ...
                                            <a href="liste_regle_client.php" style=" width:150px;"
