    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Nouvelle Gestion de paiement</h1>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane container active" id="home">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <form class="form-horizontal" action="save_gestion_paiement.php"
                                                          method="POST">
                                                        <div class="card-header">
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 25%">
                                                                                <input type="hidden" name="id_marche"
                                                                                       value="<?php echo $id ?>">
                                                                                <span class="help-block small-font">Numéro en Décompte:</span>
                                                                                <div class="col">
                                                                            ...
                                                                            <td style="width: 25%">
                                                                                <span class="help-block small-font">Date de Paiement:</span>
                                                                            ...
                                                                            <td style="width: 25%">
                                                                                <div class="form-group input-group">
                                                                                    <div class="input-group-prepend">
                                                                                        <span class="input-group-text">Montant Recue</span>
                                                                                    </div>
                                                                                    <input type="number"
                                                                                           class="form-control"
                                                                                           name="montant_paie_ht"
                                                                                           required/>
                                                                                    <div class="input-group-prepend">
