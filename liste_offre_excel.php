    ...
    <div id="layoutSidenav_content">
                                    ...
                                    <ul class="nav nav-pills" style="float: right;">
                                        <li class="nav-item">
                                            <button class="btn btn-primary"
                                                    ...
                                                    onclick="exportTableToExcel('dataTable', 'Etat Salarial')"><i
                                                        class="fas fa-download"></i> Exporter
                                            </button>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link active" href="etat_offre_excel.php" target="blank"><i
                                                        class="fas fa-download"></i>Exporter
                                            </a>
                                        </li>
                                        <!-- <li class="nav-item">
        ...
        <a href="modifier_etat_projet.php?id=' . $id_offre . '" style=" width:100px;" title="' . $commentaire . '" class="btn btn-danger" >Perdu</a>
                                                        ';
                                                                        ...
                                                                        echo '<a href="liste_offre.php" style=" width:100px;" class="btn btn-secondary" >N/A</a>';
