...
<div class="modal fade" id="verifier_delete_groupe<?= $id_groupe; ?>" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
                <form class="form-horizontal" action="delete_groupe.php" name="form" method="post">
                    <div class="form-group" style=" text-align: center;">
                        <label>Vous êtes sur de vouloir supprimer :
                            </br><b style="color :red"><?php echo $nom_groupe; ?></b>
                        </label>
                        <div class="col-sm-12">
                            <input type="hidden" name="id_groupe" value="<?= $id_groupe; ?>" class="form-control">
