    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Liste des règlements fournisseurs </h1>
                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <b>L'ensemble des règlements fournisseurs. ( A = appel d'offre - M = marché - C =
                                    chantier)</b>
                                <b>
                                    ...
                                    <ul class="nav nav-pills" style="float: right;">
                                        <li class="nav-item">
                                            <a class="nav-link active"
                                               href="<?= $reglement_fournisseur['option1_link'] ?>">
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="">
                                                    <table class="table table-bordered table-hover" id="dataTable"
                                                        ...
                                                        $query = "SELECT * from regle_fournisseur where open_close!='1' ";
                                                        $q = $db->query($query);
                                                        while ($row = $q->fetch()) {
                                                            $color = 'bg-success';
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    <a href="facture_regle_four.php?id=<?= $id_regle_four ?>"
                                                                       target="_blank">
                                                                        <?= $icon2 ?>
                                                                    </a>
                                                                </td>
                                                                ...
                                                                <td align="center" style="width: 18%"><a
                                                                    ...
                                                                    <a class="btn btn-warning"
                                                                       href="modifier_regle_fournisseur.php?id=<?= $id_regle_four; ?>"
                                                                       title="Modifier"
                                                                       style="background-color: transparent">
                                                                    ...
                                                                    <a class="btn btn-danger" type="button"
                                                                       data-toggle="modal"
                                                                       data-target="#verifier_delete_regle_fournisseur<?= $id_regle_four; ?>"
                                                                       title="supprimer"
                                                                       style="background-color: transparent">
