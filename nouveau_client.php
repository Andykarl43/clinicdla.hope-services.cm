    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Nouveau Client</h1>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane container active" id="home">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <form class="form-horizontal" action="save_client.php"
                                                          method="POST">
                                                        <div class="card-header">
                                        ...
                                        <center>
                                            <button type="submit" style=" width:150px;" name="submit_client"
