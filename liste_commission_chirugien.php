...
$sql = "SELECT DISTINCT * from chirugien where id_chirugien = '$id_medecin'";
...
foreach ($tables as $table) {
    $nom_medecin=$table['nom_c'].' '.$table['prenom_c'];
}
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                $query = "SELECT * from commission where id_entite='$id_medecin' and type_entite='C' and open_close!=1";
                                $q = $db->query($query);
                                while ($row = $q->fetch()) {
                                    $id_comi = $row['id_comi'];
                                    ...
                                    switch ($id_service){
                                        case '1';
                                            $ct=0;
                                            $sql = "SELECT DISTINCT * from regler_comi_consul where id_spe='$id_medecin' and type_spe='C'  ";
                                        ...
                                        case '2';
                                            ...
                                            $ct=0;
                                            $sql = "SELECT DISTINCT * from regler_comi_exa where id_spe='$id_medecin' and type_spe='C'  ";
                                            ...
                                            $total_exa=0;
                                            $payer_exa=0;
                                            $sql = "SELECT DISTINCT *  from regler_examen where id_medecin = '$id_medecin' and (payer+remise)-somme=0";
                                        ...
                                        case '3';
                                            ...
                                            $ct=0;
                                            $sql = "SELECT DISTINCT * from regler_comi_hosp where id_spe='$id_medecin' and type_spe='C'  ";
                                        ...
                                        case '4';
                                            $ct=0;
                                            $sql = "SELECT DISTINCT * from regler_comi_ordo where id_spe='$id_medecin' and type_spe='C'  ";
                                        ...
                                        case '5';
                                            ...
                                            $ct=0;
                                            $sql = "SELECT DISTINCT * from regler_comi_ope where id_spe='$id_medecin' and type_spe='C'  ";
                                            ...
                                            $total_ope=0;
                                            $payer_ope=0;
                                            $sql = "SELECT id_type_ope  from regler_ope where id_chirugien = '$id_medecin' and (payer+remise)-somme=0";
                                        ...
                                        case '6';
                                            ...
                                            $ct=0;
                                            $sql = "SELECT DISTINCT * from regler_comi_anes where  id_spe='$id_medecin' and type_spe='C'  ";
                                            ...
                                            $total_anes=0;
                                            $payer_anes=0;
                                            $sql = "SELECT id_type_anes  from regler_anesthesie where id_chirugien = '$id_medecin' and (payer+remise)-somme =0  ";
                                        ...
                                        case '7';
                                            ...
                                            $ct=0;
                                            $sql = "SELECT DISTINCT * from regler_comi_eco where  id_spe='$id_medecin' and type_spe='C'  ";
                                                            ...
                                                            <form class="form-horizontal" action="update_comi.php" name="form" method="post">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <input type="hidden" name="type_spe" value="C" class="form-control" >
