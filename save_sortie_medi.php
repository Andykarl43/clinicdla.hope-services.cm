...
//if($id_materiel[0]!=0 and abs($quantite[0])!=0){
    if($id!=0){
        ...
        $query = " INSERT INTO demande_medicament (heure_debut,date_debut,date_valide,etat_src,responsable,id_perso,heure,etat_dst) 
                     VALUES (:heure_debut,:date_debut,:date_valide,:etat,:resp,:id_perso,:heure,:etats)";
        ...
        $sql->bindParam(':heure', $heure_debut);
        $sql->bindParam(':etats', $etat);
        $sql->execute();
...
//                    $receveur='S';
                    ...
                    $sql = "INSERT INTO demande_materiel ( id_medi,date_debut_mat,id_ask_medi,quantite,etat_src,responsable,id_perso,etat_dst)
                                VALUES(:id_materiel,:date_debut,:id_ask_eq,:quantite,:etat,:resp,:id_perso,:etats)";
                    $req = $db->prepare($sql);
