...
<div class="modal fade" id="verifier_delete_marque_engin<?= $id_marque_engin; ?>" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
                <form class="form-horizontal" action="delete_marque_engin.php" name="form" method="post">
                    <div class="form-group" style=" text-align: center;">
                        <label>Vous êtes sur de vouloir supprimer :
                            </br><b style="color :red"><?php echo $nom; ?></b>
                        </label>
                        <div class="col-sm-12">
                            <input type="hidden" name="id_marque_engin" value="<?= $id_marque_engin; ?>"
                                   class="form-control">
                        </div>
                    </div>
