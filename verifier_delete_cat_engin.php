...
<div class="modal fade" id="verifier_delete_cat_engin<?= $id_cat_engin; ?>" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
                <form class="form-horizontal" action="delete_cat_engin.php" name="form" method="post">
                    <div class="form-group" style=" text-align: center;">
                        <label>Vous êtes sur de vouloir supprimer :
                            </br><b style="color :red"><?php echo $nom; ?></b>
                        </label>
                        <div class="col-sm-12">
                            <input type="hidden" name="id_cat_engin" value="<?= $id_cat_engin; ?>" class="form-control">
                        </div>
                    </div>
