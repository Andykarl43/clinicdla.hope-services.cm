...
?>
<?php
$id_rec_marche = $_REQUEST['id'];

$query = "SELECT * from reception_marche where id_rec_marche='" . $id_rec_marche . "'";
$q = $db->query($query);
while ($row = $q->fetch()) {
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Pièce Jointe(s): <?= $nom_rec ?></h1>
                                                    ...
                                                    <td style="width: 50%">
                                                        ...
                                                        <div class="col">
                                                            <input type="date" style="width:75%;border-top: 0; border-left: 0;
                                                                   ...
                                                                   name="date_begin" value="<?php echo $date_begin ?>"
                                                                   disabled>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="#">
                                                    <table class="table table-bordered table-hover" id="dataTable"
                                                        ...
                                                        $query = "SELECT * from pj_reception where id_rec_marche='" . $id_rec_marche . "' ";
                                                        $q = $db->query($query);
                                                        while ($row = $q->fetch()) {
                                                            $id = $row['id_pj_rec'];
                                                            $nom_pj = $row['nom_pj'];
                                                                ...
                                                                <td align="center">
                                                                    <div class="btn-group mr-2" role="group"
                                                                        ...
                                                                        <a class="btn btn-danger"
                                                                           href="delete_pj_reception.php?id=<?= $id ?>&id_rec_marche=<?= $id_rec_marche ?>"
