                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="">
                                                    <table class="table table-bordered table-hover" id="dataTable"
                                                        ...
                                                        $query = 'SELECT * from personnel where statut="POSTULANT" and attribut="N/A" and open_close!=\'1\' order by nom asc';
                                                        $q = $db->query($query);
                                                        while ($row = $q->fetch()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center"><a
                                                                            href="details_postulant.php?id=<?php echo $id_personnel; ?>"
                                                                            title="<?= $nom; ?>"
                                                                ...
                                                                <td align="center">
                                                                    <div class="btn-group mr-2" role="group"
                                                                        ...
                                                                        <a class="btn btn-primary"
                                                                           href="modifier_statut_postulant.php?id=<?= $id_personnel; ?>"
                                                                           title="Modifier"
                                                                ...
                                                                <td align="center" style="width: 18%">
                                                                    ...
                                                                    <div class="btn-group mr-2" role="group"
                                                                         aria-label="First group">
                                                                        <a class="btn btn-primary"
                                                                           href="details_postulant.php?id=<?= $id_personnel; ?>"
                                                                           title="view"
                                                                           style="background-color: transparent">
                                                                            <i style="color: green"
                                                                               class="fas fa-eye"></i>
                                                                    ...
                                                                    <div class="btn-group mr-2" role="group"
                                                                        ...
                                                                        <a class="btn btn-warning"
                                                                           href="modifier_postulant.php?id=<?= $id_personnel; ?>"
                                                                           title="Modifier"
                                                                           style="background-color: transparent">
                                                                    ...
                                                                    <div class="btn-group mr-2" role="group"
                                                                        ...
                                                                        <a class="btn btn-danger"
                                                                           href="delete_postulant.php?id=<?= $id_personnel ?>"
                                                                           style="background-color: transparent">
                                                                            <i style="color: red"
