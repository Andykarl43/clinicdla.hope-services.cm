...
//--------------------------------- insertion un fournisseur -----------------------------------------//
    if ($reste >= 0) {
        ...
        $query = " INSERT INTO regle_fournisseur (id_fournisseur,id_card_bank,date_transaction,id_choix,type,date_echeance,montant,avance,id_mode_paiement,reste,cheque,open_close) 
                     VALUES (:id_fournisseur,:id_card_bank,:date_transaction,:id_choix,:type,:date_echeance,:montant,:avance,:id_mode_paiement,:reste,:cheque,:open_close)";
        ...
        ?>
        <script>
            alert('L\'avance ou montant est incorrect.');
