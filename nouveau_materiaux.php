    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Nouveau Matériel</h1>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane container active" id="home">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <form class="form-horizontal" action="save_materiaux.php"
                                                          method="POST">
                                                        <div class="card-header">
                                                            ...
                                                            <fieldset>
                                                                <div class="table-responsive">
                                                                    <table border="0"
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <span class="help-block small-font">Réferrence:</span>
                                                                                <div class="col">
                                                                                    <input style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;"
                                                                                           name="ref_materiel" required>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <span class="help-block small-font">Désignation:</span>
                                                                                <div class="col">
                                                                                    <input style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;"
                                                                    ...
                                                                    border-left-color: orange;">
                                                                                        <a href="liste_cat_materiel.php"><i
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                border-color: gray" name="prix_unitaire"
                                                                                           value="0" required>
                                                                                    </button>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                border-color: gray" name="prix_total"
                                                                                           value="0" required>
                                                                                    </button>
                                                                                </div>
                                                                            </td>
