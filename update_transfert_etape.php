    ...
    if ($quantite_etape >= 0) {
        ...
        while ($row = $q->fetch()) {
            ...
            if ($quantite_total > 0) {
                ...
                $sql3 = "SELECT DISTINCT count(id_etape) as total from magasin_etape where id_etape = '$id_etape' and id_materiel='$id_materiel'";
                ...
                foreach ($tables3 as $tables) {
                    ...
                    if ($total != 1) {
                        ...
                        $query = " INSERT INTO magasin_etape (id_chantier,id_etape,id_materiel,quantite_etape,date_mag_etape,prix_unitaire_mag_etape,prix_total_mag_etape) 
                    VALUES (:id_chantier,:id_etape,:id_materiel,:quantite_etape,:date_mag_etape,:prix_unitaire,:prix_total)";
                        ...
                        if ($quantite_total > 0) {
                            ...
                            <script>
                                ...
                                window.location.href = 'ajouter_etape_materiel.php?id=<?=$id_etape?>&idc=<?=$idc?>&witness=1';
                            </script>
                            <?php
                        } else {
                            ?>
                        ...
                        $sql = "SELECT DISTINCT * from magasin_etape where id_etape = '$id_etape' and id_materiel='$id_materiel' ";
                        ...
                        foreach ($tables as $table) {
                            ...
                            $query = "UPDATE magasin_etape SET  quantite_etape=:quantite_etape, date_mag_etape=:date_mag_etape, prix_total_mag_etape=:prix_total_final where id_materiel = '$id_materiel' and id_etape = '$id_etape' ";
                ...
                <script>
                    ...
                    window.location.href = 'ajouter_etape_materiel.php?id=<?=$id_etape?>&idc=<?=$idc?>&witness=-2';
                </script>
                <?php
