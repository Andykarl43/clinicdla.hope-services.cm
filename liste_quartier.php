...
?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    ...
                                                                    foreach ($tables as $table) {
                                                                        echo ucfirst(strtolower($table['nom']));
                                                                    }

                                                                    ?>
                                                                </td>
                                                                <td align="center"><a class="btn btn-danger"  href="delete_quartier.php?id_quartier=<?=$id_quat ?>"   onclick="Supp(this.href); return(false);" style="background-color: transparent">
    ...
    <script type="text/javascript">
        function Supp(link){
            if(confirm('Confirmer  la suppression du quartier ?')){
