    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Liste des spécialistés</h1>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <form class="form-horizontal" action="save_specialiste.php" method="POST">
                                    ...
                                    <fieldset>
                                        <div class="table-responsive">
                                            <table class="table  table-hover table-condensed" id="myTable">
                                                ...
                                                <tr>
                                                    <td style="width:50%">
                                                        <span class="help-block small-font">Département<span class="text-danger">*</span></span>
                                                        <div class="col">
                                                            <select name="id_depart" style="width:75%;
                                                            ...
                                                            <button type="button" style="background-color: transparent; border-radius: 20px; border-color: black; border-bottom-color: yellow; border-top-color: red;
                                                                    ...
                                                                    border-left-color: orange;">
                                                                                        <a href="liste_departement.php"><i
                                                    ...
                                                    <td>
                                                        <span class="help-block small-font">Spécialité<span class="text-danger">*</span></span>
                                                        <div class="col">
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="">
                                                    <table class="table table-bordered" id="dataTable" width="100%"
                                                        ...
                                                        <thead>
                                                        <tr class="bg-primary">
                                                            <th><p align="center">Spécialités</p></th>
                                                            <th><p align="center">Département</p></th>
                                                        ...
                                                        $query = "SELECT * from specialiste order by nom desc ";
                                                        $q = $db->query($query);
                                                        while ($row = $q->fetch()) {
                                                            $id_spe = $row['id_spe'];
                                                            $nom = $row['nom'];
                                                         ...
                                                         ?>
                                                            <tr>
                                                                ...
                                                                <td align="center"><a class="btn btn-danger"  href="delete_specialiste.php?id_spe=<?=$id_spe?>"  style="background-color: transparent">
