    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Nouveau Groupement</h1>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane container active" id="home">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <form class="form-horizontal" action="save_group.php" method="POST">
                                                        <div class="card-header">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                background: transparent;"
                                                                                           name="nom_group" required>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <span class="help-block small-font">MARCHE:</span>
                                                                                <div class="col">
                                                                                    <input type="hidden"
                                                                                           name="id_marche"
                                                                                           value="<?= $id_marche ?>">
                                                                                    <select name="id_marche" style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" disabled="">
                                                                                        <option value="<?= $id_marche ?>"
                                                                                                selected="">
                                                                                            <?php
                                                                                            $sql = "SELECT DISTINCT * from marche where id_marche = '$id_marche'";
