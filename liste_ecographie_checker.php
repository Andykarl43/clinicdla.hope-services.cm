                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header" style="padding:20px 50px;">
                                                            <h3 align="center"><i class="fas fa-map"></i> <b>Reglement: <?=$ref_eco?></b></h3>
                                                        ...
                                                        <div class="modal-body" style="padding:40px 50px;">
                                                            <form class="form-horizontal" action="update_eco_paye.php" name="form" method="post">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <input type="hidden" name="id_reg_eco" value="<?=$id_reg_eco?>" class="form-control" >
                                                                        <input type="hidden" name="id_perso_session" value="<?=$id_perso_session?>" class="form-control" >
                                                                        <input type="hidden" name="id_eco" value="<?=$id_eco?>" class="form-control" >
