...
//--------------------------------- insertion un fournisseur -----------------------------------------//
        ...
        $query = " INSERT INTO regle_partie (id_partie,id_card_bank,date_transaction,id_choix,type,date_echeance,montant,avance,id_mode_paiement,reste,cheque,open_close) 
                     VALUES (:id_partie,:id_card_bank,:date_transaction,:id_choix,:type,:date_echeance,:montant,:avance,:id_mode_paiement,:reste,:cheque,:open_close)";
        ...
        if ($sql) {
            ?>
            <script>
                alert('Règlement sous-traitant a été bien enregistrée.');
                window.location.href = '<?=$reglement['option2_link']?>?witness=1';
            </script>
            <?php
        } else {
            ?>
        ...
        <script>
            ...
            window.location.href = '<?=$reglement['option2_link']?>?witnes=-2';
        </script>
        <?php
    }
